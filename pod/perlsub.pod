...
Lexical subroutines are only available under the C<use experimental
'lexical_subs'> or C<use feature 'experimental::lexical_subs'> pragma.
...
declared, and only after that declaration:
    ...
    use 5.018; use experimental 'lexical_subs';
...
necessary if you want to create closures:
    ...
    use 5.18; use experimental 'lexical_subs';
